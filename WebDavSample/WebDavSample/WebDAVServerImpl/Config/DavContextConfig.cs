...
using WebDavSample.WebDAVServerImpl.ExtendedAttributes;
namespace WebDavSample.WebDAVServerImpl.Configuration
{
    /// <summary>
    ...
    public static class DavContextConfigValidator
    {
        ...
        public static async Task ReadConfigurationAsync(this IConfigurationSection configurationSection, DavContextConfig config, IWebHostEnvironment env)
        {
            ...
            {
                throw new DirectoryNotFoundException(string.Format("DavContext.RepositoryPath specified in appsettings.webdav.json is invalid: '{0}'.", config.RepositoryPath));
            }
