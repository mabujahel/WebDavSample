...
using WebDavSample.WebDAVServerImpl.Configuration;

namespace WebDavSample.WebDAVServerImpl
{
    /// <summary>
    ...
    public static class DavEngineMiddlewareExtensions
    {
        ...
        public static void AddWebDav(this IServiceCollection services, IConfiguration configuration, IWebHostEnvironment env)
        {
